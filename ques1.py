...
# Complete the flowchart as per the above instructions.


# Once the flowchart is complete, write the Python program and save it as .py file. 
# Submit both the files together.
